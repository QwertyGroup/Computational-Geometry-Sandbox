            ...
            begin
                for j:=1 to b do
                    case Table[i,j] of
                        ...
                        2:begin TextColor(14); write(char(248)); end;
                        4..5:begin TextColor(14); write(char(248)); end;
                        7:begin TextColor(14); write(char(248)); end;
                        3:begin TextColor(13); write(char(248)); end;
                        6:begin TextColor(13); write(char(248)); end;
                        8:begin TextColor(13); write(char(248)); end;
                    end;
                writeln;
            end;
    end;
        ...
        for i:=1 to a do
            for j:=1 to b do
                if arg = 1 then
                    ...
                    begin
                        if (fDot(j,i,2)) and (not(BoolTable[i,j])) then
                            begin
                                inc(Table[i,j],5);
                                BoolTable[i,j]:=true;
                            end;
...
{----Test----}
(*procedure pTest(x1,y1,x2,y2:integer; arg:byte);
    var v:integer;
    begin
        if (y1=y2) and (x1=x2) then {Если точка}
            begin
